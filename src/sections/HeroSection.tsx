...
export default ({activeSection, setActiveSection}:{activeSection: string, setActiveSection: any}) => (
    <section
        id="home"
        className="relative h-screen flex flex-col justify-center items-center text-center p-4 md:p-8 clickable"
        onClick={() => setActiveSection("home")}
    >
        <div className="absolute inset-0 bg-gradient-to-br from-amber-950 to-emerald-900 opacity-70 z-0"></div>
        <div className="relative z-10 p-6 md:p-12 rounded-2xl bg-emerald-900 bg-opacity-50 backdrop-blur-sm shadow-xl max-w-5xl mx-auto hover:scale-105 transition-transform duration-300">
